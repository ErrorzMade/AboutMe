...
To start, there will be a new hotkey. **M** (default). When pressed, you will be greated with a menu that looks something like this (subject to change)
![](mapsoverview.png)
You will have an overview of all the maps, with their names & images of the map to help you easily just find the map you're looking for. They're grouped by map sizes. When you click into them, you will be greeted with something like this.
![](willowplan.png)
As you can see, you can cycle between the floors on the building, as well as see where all the cursed possessions live, where the exit door is and just where the rooms are. As well as that, you will be able to see the breaker locations. If you click on one of the cursed item, you will be shown the cursed object in the real map to help you find it.
![](cursedwillow.png)
